...
3. The `Start` text should now be replaced with `Running` and with other commands such as `Stop`. You can now prompt the LLM to access resources there. For instance, for `ado`, it can now handle AB items with prompts like 'Do task 44300'.
