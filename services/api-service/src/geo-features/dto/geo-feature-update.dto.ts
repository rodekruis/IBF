...
export class GeoFeatureUpdateDto {
  @ApiPropertyOptional({ enum: GeoFeatureType, example: GeoFeatureType.point })
  @IsOptional()
  @IsEnum(GeoFeatureType)
  public readonly featureType?: GeoFeatureType;

  @ApiPropertyOptional({ enum: Layer, example: Layer.glofasStations })
  @IsOptional()
  @IsEnum(Layer)
  public readonly layer?: Layer;

  @ApiPropertyOptional({ example: 'G5142' })
  @IsOptional()
  @IsString()
