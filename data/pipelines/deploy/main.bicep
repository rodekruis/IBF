...
// (ADX) is decided post-prototype (see data/pipelines/deploy/readme-implementation.md).
...
// this workspace and revisited post-POC (see data/pipelines/deploy/readme-implementation.md).
