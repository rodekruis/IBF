...
class TestGetAdminAreas:
    ...
    def test_returns_feature_collection_on_success(self, mock_get: MagicMock) -> None:
    ...
    @patch.object(requests.Session, "get")
    def test_returns_empty_dict_on_error_response(self, mock_get: MagicMock) -> None:
        """Non-200 response returns an empty dict."""
