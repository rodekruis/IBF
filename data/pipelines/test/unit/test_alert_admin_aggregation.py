...
def test_numeric_aggregation_uses_sum_basic():
    # Parent population = sum of children (100 for parent-X, 50 for parent-Y)
    alert = _make_alert(
        [
            ExposureAdminArea("child-A", 3, LayerName.EXPOSED_POPULATION, 100),
            ExposureAdminArea("child-B", 3, LayerName.EXPOSED_POPULATION, 0),
            ExposureAdminArea("child-C", 3, LayerName.EXPOSED_POPULATION, 50),
        ]
    )
...
def test_numeric_aggregation_uses_sum():
    ...
    alert = _make_alert(
        [
            ExposureAdminArea("child-A", 3, LayerName.EXPOSED_POPULATION, 100),
            ExposureAdminArea("child-B", 3, LayerName.EXPOSED_POPULATION, 250),
            ExposureAdminArea("child-C", 3, LayerName.EXPOSED_POPULATION, 50),
        ]
    )
...
def test_aggregation_produces_all_levels():
    ...
    alert = _make_alert(
        [
            ExposureAdminArea("child-A", 3, LayerName.EXPOSED_POPULATION, 1),
            ExposureAdminArea("child-B", 3, LayerName.EXPOSED_POPULATION, 1),
            ExposureAdminArea("child-C", 3, LayerName.EXPOSED_POPULATION, 0),
        ]
    )
...
def test_grandparent_sums_from_deepest_not_from_parents():
    ...
    alert = _make_alert(
        [
            ExposureAdminArea("child-A", 3, LayerName.EXPOSED_POPULATION, 100),
            ExposureAdminArea("child-B", 3, LayerName.EXPOSED_POPULATION, 200),
            ExposureAdminArea("child-C", 3, LayerName.EXPOSED_POPULATION, 50),
        ]
    )
...
def test_two_level_hierarchy():
    ...
    alert = _make_alert(
        [
            ExposureAdminArea("child-A", 2, LayerName.EXPOSED_POPULATION, 10),
            ExposureAdminArea("child-B", 2, LayerName.EXPOSED_POPULATION, 20),
        ]
    )
...
def test_unknown_place_code_is_skipped():
    ...
    alert = _make_alert(
        [
            ExposureAdminArea("unknown", 3, LayerName.EXPOSED_POPULATION, 100),
        ]
    )
...
def test_multiple_layers_aggregated_independently():
    ...
    level_2 = _entries_at_level(alert, 2)
    population = [e for e in level_2 if e.layer == LayerName.EXPOSED_POPULATION]
